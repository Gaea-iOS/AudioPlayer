...
public class AudioPlayer: NSObject {
    ...
    lazy var networkEventProducer = NetworkEventProducer(reachability: reachability)
...
//                player = nil
                ...
                //Sets new state
                let url = currentItem.soundURL
                if reachability.connection != .none || url.ap_isOfflineURL {
                    state = .buffering
